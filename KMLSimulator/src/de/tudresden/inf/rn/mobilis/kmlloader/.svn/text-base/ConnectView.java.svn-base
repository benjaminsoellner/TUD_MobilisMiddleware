...
public class ConnectView extends JDialog implements ActionListener {
	...
	private void initializeSettings() {
		this.settings.add(new Setting("host", "Host", "yourhost"));
		this.settings.add(new Setting("port", "Port", "5222"));
		this.settings.add(new Setting("service", "Service", "yourhost"));
		this.settings.add(new Setting("user", "XMPP-User", "youruser"));
		this.settings.add(new Setting("password", "XMPP-Password",  ""));
		this.settings.add(new Setting("ressource", "XMPP-Ressource", "KMLLoader"));
		this.settings.add(new Setting("androidbuddy", "Androidbuddy-User", "androidbuddy@yourhost/MobilisServer"));
